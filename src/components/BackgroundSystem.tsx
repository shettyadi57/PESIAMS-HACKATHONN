    ...
    <div className="fixed inset-0 -z-50 w-full h-full bg-[#050505] overflow-hidden pointer-events-none">
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(
              var(--cursor-glow-size, 350px) circle at var(--cursor-vx, -1000px) var(--cursor-vy, -1000px),
              rgba(6, 182, 212, calc(0.12 * var(--cursor-glow-intensity, 1))) 0%,
              rgba(139, 92, 246, calc(0.06 * var(--cursor-glow-intensity, 1))) 45%,
              transparent 100%
            ),
            radial-gradient(
              calc(var(--cursor-glow-size, 350px) * 0.8) circle at var(--cursor-vxb, -1000px) var(--cursor-vyb, -1000px),
              rgba(139, 92, 246, calc(0.06 * var(--cursor-glow-intensity, 1))) 0%,
              rgba(59, 130, 246, calc(0.04 * var(--cursor-glow-intensity, 1))) 50%,
              transparent 100%
            ),
            radial-gradient(
              calc(var(--cursor-glow-size, 350px) * 0.6) circle at var(--cursor-vxc, -1000px) var(--cursor-vyc, -1000px),
              rgba(59, 130, 246, calc(0.04 * var(--cursor-glow-intensity, 1))) 0%,
              transparent 100%
            )
          `,
          filter: "blur(15px)",
